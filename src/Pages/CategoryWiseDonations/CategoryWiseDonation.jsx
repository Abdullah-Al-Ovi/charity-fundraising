    ...
    return (
        <div className="bg-white shadow-md rounded-lg overflow-hidden transition-transform duration-300 hover:scale-105">
            ...
            <div className="p-5">
                ...
                <p className={`mt-3 px-4 py-1 inline-block text-sm font-semibold rounded-full ${status === 'running' ? 'bg-green-200 text-green-800' : status === 'closed' ? 'bg-red-200 text-red-800' : 'bg-yellow-200 text-yellow-800'}`}>
